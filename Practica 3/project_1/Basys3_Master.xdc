...
set_property PACKAGE_PIN U2 [get_ports {EN0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {EN0}]
set_property PACKAGE_PIN U4 [get_ports {EN1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {EN1}]
set_property PACKAGE_PIN V4 [get_ports {EN2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {EN2}]
set_property PACKAGE_PIN W4 [get_ports {EN3}]					
...
#set_property PACKAGE_PIN G17 [get_ports {vgaGreen[2]}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {vgaGreen[2]}]#set_property PACKAGE_PIN U16 [get_ports {led[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led[0]}]
#set_property PACKAGE_PIN E19 [get_ports {led[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led[1]}]
#set_property PACKAGE_PIN U19 [get_ports {led[2]}]					
