...
HD_PWD='/home/estudiante/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PBCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PBCounter.tcl
