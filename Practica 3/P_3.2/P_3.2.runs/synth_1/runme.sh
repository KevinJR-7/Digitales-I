...
HD_PWD='/home/estudiante/practica3.2/practica3.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parte2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parte2.tcl
