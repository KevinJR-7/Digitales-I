...
HD_PWD='C:/Users/HOME/Desktop/Digital lab2/funcion/funcion.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log funcion.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source funcion.tcl
