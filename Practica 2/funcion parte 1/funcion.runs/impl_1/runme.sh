...
HD_PWD='C:/Users/HOME/Desktop/Digital lab2/funcion/funcion.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log funcion.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source funcion.tcl -notrace
